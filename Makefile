...
#    Updated: 2024/02/21 21:22:22 by azgaoua          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME		=	miniRT
#SRCS		=	$(shell find ./sources -iname "*.c")
SRCS		=	my_main.c sources/geometry/cylinder.c sources/geometry/hits.c sources/geometry/lists.c \
				 sources/geometry/objects.c sources/geometry/plane.c sources/geometry/rays.c sources/geometry/sphere.c \
